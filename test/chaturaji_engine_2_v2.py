...
# BUG: RED walks his king to death
                ...
                if piece:
                    if not piece.is_dead and piece.player in board.active_players:
                      ...
                      if piece.piece_type != PieceType.PAWN:
                          ...
                          or (piece.player == Player.RED and row == 7)
                          or (piece.player == Player.RED and row == 7)
                          or (piece.player == Player.RED and row == 7)):
...
if __name__ == '__main__':
    ...
    # board.make_move((Move(BoardLocation(5, 7), BoardLocation(5, 1)))) # green bishop move # will red take this free bishop
