...
def max_4(board, depth): # add root player parameter? -> def negamax4(board, depth, root_player):
    global nodes
    nodes += 1
...
if __name__ == '__main__':
    ...
    board.make_move((Move(BoardLocation(2, 0), BoardLocation(5, 1)))) # offer a free bishop to red - will he take it or avoid getting mated
    board.current_player = Player.RED # will red move his king to escape getting captured? # Does when the depth is more than 4, ie, he can see what green is going to play
